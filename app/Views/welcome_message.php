...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="/demo" >Demo Page with View</a>
            </li>
        </ul>
    </div>
    ...
    <div class="heroe">
        ...
        <h2>A simplest CodeIgniter Demo Application By <span class="name">Rajendra</span> as per assignment.</h2>
